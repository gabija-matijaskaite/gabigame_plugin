...
/**
 * Capability definitions for the gabigame module
 *
...
$capabilities = array(
    ...
    'mod/gabigame:addinstance' => array(
    ...
    'mod/gabigame:reviewmyattempts' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW
    ...
    'mod/gabigame:viewreports' => array(
    ...
    'mod/gabigame:viewallscores' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
                'editingteacher' => CAP_ALLOW,
