...
const Game = class {
    ...
    load(levels) {
        ...
        let params = this.setDatabaseParams();

        fetch("js/game/ajax_controller.php",{
            method: "POST",
            mode: 'cors',
            credentials: 'omit',
            headers: {
            ...
            body: new URLSearchParams({
                ...
                'gabigameid': params.gabigameid,
                'world': params.gameWorld,
                'level': params.gameLevel
            })
        })
        .then(response => {
            // handle the response
    ...
    setDatabaseParams() {
        ...
        var gabigameid = window.gabigameid || null;
        var gameWorld = window.dbWorld || null;
        var gameLevel = window.dbLevel || null;
        
        return {userid, gabigameid, gameWorld, gameLevel};
    }
